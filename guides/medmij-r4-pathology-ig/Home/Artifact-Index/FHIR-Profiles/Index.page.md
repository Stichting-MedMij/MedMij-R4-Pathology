...
| --- | --- | --- |
| {{pagelink: PathLmPatient, text: Patient}} | Patient | {{pagelink: FHIRProfilesIndex, text: path-Patient, anchor: PathPatient}} |
| {{pagelink: PathLmRequest, text: Request}} | ServiceRequest | {{pagelink: FHIRProfilesIndex, text: path-Request, anchor: PathRequest}} |
| {{pagelink: PathLmRequest, text: Request (Requester)}} | PractitionerRole | {{pagelink: FHIRProfilesIndex, text: path-Request.Requester, anchor: PathRequestRequester}} |
| {{pagelink: PathLmRequest, text: Request (Specimen)}} | Specimen | {{pagelink: FHIRProfilesIndex, text: path-Request.Specimen, anchor: PathRequestSpecimen}} |
| {{pagelink: PathLmReport, text: Report}} | DiagnosticReport | {{pagelink: FHIRProfilesIndex, text: path-Report, anchor: PathReport}} |
| {{pagelink: PathLmReport, text: Report (ClinicalInformation)}} | Observation | {{pagelink: FHIRProfilesIndex, text: path-Report.ClinicalInformation, anchor: PathReportClinicalInformation}} |
| {{pagelink: PathLmReport, text: Report (Macroscopy)}} | Observation | {{pagelink: FHIRProfilesIndex, text: path-Report.Macroscopy, anchor: PathReportMacroscopy}} |
| {{pagelink: PathLmReport, text: Report (Microscopy)}} | Observation | {{pagelink: FHIRProfilesIndex, text: path-Report.Microscopy, anchor: PathReportMicroscopy}} |
| {{pagelink: PathLmReport, text: Report (ProtocolDataItem)}} | Observation | {{pagelink: FHIRProfilesIndex, text: path-Report.ProtocolDataItem, anchor: PathReportProtocolDataItem}} |
