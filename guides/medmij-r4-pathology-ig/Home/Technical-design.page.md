...
## Introduction
This technical design provides the technical specification of the Pathology (Dutch: Pathologie) standard. The national infrastructure for exchanging pathology data ([Mercurius](https://www.palga.nl/nieuws/infrasructuur)) developed and maintained by [Palga](https://www.palga.nl/) forms the foundation for this standard.
