...
* .
  * ^alias = "Patiënt"
* Name 1..1 BackboneElement "Name of the patient."
  * ^alias = "Naam"
  * Initials 1..1 string "Initials of the patient in capitals, divided by dots."
    * ^alias = "Voorletters"
  * FamilyName 1..1 BackboneElement "Family name of the patient."
    * ^alias = "Geslachtsnaam"
    * Prefix 0..1 string "Prefix to the last name of the patient."
      * ^alias = "Voorvoegsels"
    * LastName 1..1 string "Last name of the patient."
      * ^alias = "Achternaam"
* Gender 1..1 code "Gender of the patient."
* Gender from MercuriusGender_VS (required)
  * ^alias = "Geslacht"
* BirthInformation 1..1 BackboneElement "Information on the birth of the patient."
  * BirthDate 1..1 date "Birth date."
    * ^alias = "Geboortedatum"
  * BirthPlace 0..1 string "Place of birth."
    * ^alias = "Geboorteplaats"
    * ^comment = "The place of birth is part of the CIS personalia as delivered by the CIS-GBA."
  * BirthCountry 0..1 string "Country of birth."
    * ^alias = "Geboorteland"
* Address 1..1 Address "Address of the patient."
  * Street 0..1 string "Street name of the address."
    * ^alias = "Straat"
  * HouseNumber 0..1 string "House number of the address."
    * ^alias = "Huisnummer"
  * PostalCode 1..1 string "Postal code, either Dutch or foreign."
    * ^alias = "Postcode"
    * ^comment = """
...
* .
  * ^alias = "Aanvraag"
* RequestType 1..1 CodeableConcept "This additional typing of the examination can provide a trigger to avoid sending to ZIS, CIS, National Dababase or others, or to send a consultation report (electronically) to another lab."
...
* HealthScreeningType 1..1 CodeableConcept "Type of national trial for this request."
...
* Requester 1..1 BackboneElement "Requester of the pathology study."
  * ^alias = "Aanvrager"
  * RequesterName 1..1 string "Name of the requester."
    * ^alias = "AanvragerNaam"
  * Specialty 1..1 CodeableConcept "Specialty of the requester."
  * Specialty from MercuriusSpecialty_VS (extensible)
    * ^alias = "Specialisme"
  * Hospital 1..1 string "Name of the hospital from where the specimen is sent."
    * ^alias = "Ziekenhuis"
  * Location 1..1 string "Location of requesting institute."
    * ^alias = "Locatie"
* ClinicalQuestion 1..1 string "Clinical request information."
  * ^alias = "KlinischeVraag"
* Specimen 1..1 BackboneElement "Specimen that will be examined by a laboratory."
  * ^alias = "Monster"
  * SpecimenMaterial 1..1 CodeableConcept "Type of specimen."
  // Specify ValueSet
    * ^alias = "AardMateriaal"
  * CollectionDate 0..1 date "Date when specimen is taken from patient."
    * ^alias = "DatumAfname"
  * ReceivedDate 1..1 date "Date when specimen is received at the laboratory."
    * ^alias = "DatumOntvangst"
  * CollectionMethod 1..1 CodeableConcept "The way the specimen is collected (biopsy, resection, etc.)."
  // Specify ValueSet
...
* .
  * ^alias = "Verslag"
* ReportIdentifier 1..1 Identifier "Identifier of the report."
  * ^alias = "VerslagIdentificatienummer"
  * ^comment = "These identifiers attain values of the form [TCSB]YY-nnnnn or [TCSB]YY-nnnnnn (based on the laboratory the report originates from), e.g. T26-012345."
* Authorizer 1..1 string "Name of the pathologist who has authorized the report."
  * ^alias = "Autorisator"
* AuthorizationDate 1..1 date "Date of authorization."
  * ^alias = "DatumAutorisatie"
* FirstAuthorizationDate 1..1 date "Date of first authorization. Not to be overwritten when authorized again."
  * ^alias = "DatumEersteAutorisatie"
* Protocol 1..1 string "Name of the protocol that is used in the Palga Protocol Module to fill the report."
  * ^alias = "Protocol"
* ClinicalInformation 1..1 string "Clinical information section of the report."
  * ^alias = "KlinischeGegevens"
* Macroscopy 1..1 string "Macroscopy-related results."
  * ^alias = "Macroscopie"
* Microscopy 1..1 string "Microscopy-related results."
  * ^alias = "Microscopie"
* Conclusion 1..1 string "Conclusion of the report."
  * ^alias = "Conclusie"
* ProtocolOutput 1..1 string "Output from National Palga Protocols, created in the Palga Protocol Module."
...
* Protocol -> "mercurius-core-rubriek-140" "protocolnaam"
