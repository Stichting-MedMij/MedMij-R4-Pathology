...
* Requester 1..1 BackboneElement "Requester" "Requester of the pathology study."
  ...
  * Hospital 1..1 string "Hospital" "Name of the hospital from where the specimen is sent."
    * ^alias = "Ziekenhuis"
  * Location 1..1 string "Location" "Location of requesting institute."
    * ^alias = "Locatie"
...
* Specimen 1..1 BackboneElement "Specimen" "Specimen that will be examined by a laboratory."
  ...
  * CollectionMethod 1..1 CodeableConcept "Collection method" "The way the specimen is collected (biopsy, resection, etc.)."
  // Specify ValueSet
...
* FirstAuthorizationDate 1..1 date "First authorization date" "Date of first authorization. Not to be overwritten when authorized again."
  * ^alias = "DatumEersteAutorisatie"
* Protocol 1..1 string "Protocol" "Name of the protocol that is used in the Palga Protocol Module to fill the report."
  * ^alias = "Protocol"
* ClinicalInformation 1..1 string "Clinical information" "Clinical information section of the report."
  * ^alias = "KlinischeGegevens"
* Macroscopy 1..1 string "Macroscopy" "Macroscopy-related results."
  * ^alias = "Macroscopie"
* Microscopy 1..1 string "Microscopy" "Microscopy-related results."
  * ^alias = "Microscopie"
* Conclusion 1..1 string "Conclusion" "Conclusion of the report."
  * ^alias = "Conclusie"
* ProtocolOutput 1..1 string "Protocol output" "Output from National Palga Protocols, created in the Palga Protocol Module."
